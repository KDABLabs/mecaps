...
{
  public:
	explicit AbstractFtpTransferHandle(std::string url, bool verbose = false);
...
{
  public:
	FtpDownloadTransferHandle(File &file, std::string url, bool verbose = false);
...
{
  public:
	FtpUploadTransferHandle(File &file, std::string url, bool verbose = false);
